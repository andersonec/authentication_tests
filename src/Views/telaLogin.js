...
class Login extends Component {
    ...
    loginGoogle = () => {
        // CHAMAR API VIA AXIOS
        axios({
            method: 'post',
            url: 'https://localhost:5001/signin-google',
            data: {
                email: 'a@email.com',
                password: '12345'
            }
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <TouchableHighlight
                ...
                <Text style = {styles.submitButtonText}>Facebook</Text>
            </TouchableHighlight>
            ...
            <TouchableHighlight
                ...
                <Text style = {styles.submitButtonText}>Google</Text>
            </TouchableHighlight>
        </View>
    );
  }
